    ...
    const getProductReview = async () => {
        ...
        try {
            const { data } = await axios.get(
                `https://api-nhaxinh.onrender.com/api/review/byProduct/${product._id}`
            );
        ...
        try {
            ...
            if (!auth?.user) {
                ...
                if (count <= 0) {
                    ...
                    const { data } = await axios.post(
                        "https://api-nhaxinh.onrender.com/api/cart/addtoCart",
                        {
                            productId: product._id,
                            quantity: count,
                        }
                ...
                <div className="p-3 mt-2 h-auto md:flex md:max-w-[1280px] justify-between mx-auto">
                    ...
                    <div className="w-full h-full md:w-[40%] md:p-4">
                        ...
                        <div className="flex mt-8">
                            ...
                            >
                                {isInWishlist(product._id) ? (
                                    <IoMdHeart
                                        className="w-1/10 cursor-pointer mr-2"
                                        size={24}
                                    />
                                ) : (
                                    <CiHeart
                        ...
                        <div className="mt-5 md:mt-10 w-full h-auto">
                            ...
                            >
                                <p>
                                    Các sản phẩm nội thất tại LC đa số đều được
                                    sản xuất tại nhà máy của công ty cổ phần xây
                                    dựng kiến trúc AA với đội ngũ nhân viên và
                                    công nhân ưu tú cùng cơ sở vật chất hiện đại
                                    . LC đã kiểm tra kỹ lưỡng từ nguồn nguyên
                                    liệu cho đến sản phẩm hoàn thiện cuối cùng.
                                </p>
                                <p>
                                    LC bảo hành một năm cho các trường hợp có
                                    lỗi về kỹ thuật trong quá trình sản xuất hay
                                    lắp đặt.
                                </p>
                                <p>
                                    Quý khách không nên tự sửa chữa mà hãy báo
                                    ngay cho LC qua hotline: 1800 7200.
                                </p>
                                <p>
                                    Sau thời gian hết hạn bảo hành, nếu quý
                                    khách có bất kỳ yêu cầu hay thắc mắc thì vui
                                    lòng liên hệ với LC để được hướng dẫn và
                                ...
                                <p>Sản phẩm không có phiếu bảo hành của LC.</p>
                            ...
                            >
                                ...
                                <p>
                                    LC cung cấp dịch vụ giao hàng tận nơi, lắp
                                    ráp và sắp xếp vị trí theo đúng ý muốn của
                                    quý khách:
                                </p>
                                <p>
