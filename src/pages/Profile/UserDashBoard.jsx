...
const UserProfile = () => {
    ...
    useEffect(() => {
        if (address && address.province) {
            const temp = provinces.find((p) => p.province_name === address.province);
    ...
    useEffect(() => {
        if (address && address.district) {
            const temp = disctricts.find((p) => p.district_name === address.district);
                ...
                <div class="basis-3/6 text-center m-4">
                    ...
                    <div className="flex flex-grow mt-8">
                        <div class="flex flex-col mx-4 w-full">
                            ...
                            <input type="password" className="form-control  w-full mr-16 mt-4 p-4 border-2 border-gray-300"
                                value={passwordNow}
                        ...
                        <div class="flex flex-grow mx-4 w-full">
                            <div className="w-full md:flex md:flex-wrap md:justify-start">
                                {addresses?.map((p, index) => (
                                    <div>
                                        <button className="px-4 py-2 border-2 mr-4 border-gray-300 text-lg"
                    ...
                    {address ? (
                        ...
                        <div className="flex flex-col m-4">
                            ...
                            <div class="flex flex-col  mt-4 w-full">
                                ...
                                <select id="district" class="block w-full px-4 py-3 text-base text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    ...
                                    onChange={(e) => {
                                        ...
                                        setSelectedDisctrictId(e.target.value);
                                    }}
                                >
                            ...
                            <div className="flex flex-grow mt-4">
                                <button className="bg-black border border-black text-[20px] px-6 py-2 uppercase text-white cursor-pointer mt-2 font-bold" onClick={updateAddress}>
                                    CẬP NHẬT ĐỊA CHỈ
                                </button>
                                <button className="bg-black border border-black text-[20px] px-6 py-2 uppercase text-white cursor-pointer mt-2 font-bold mx-4" onClick={deleteAddress}>
                                    XÓA ĐỊA CHỈ
                                </button>
                            </div>
                        </div>
